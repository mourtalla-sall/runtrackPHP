...
requête SQL, sélectionnez dans une colonne nommée “capacite_totale” la
somme des capacités des salles. Affichez le résultat de cette requête dans un
...
<body>
    <table>
        <thead>
            <tr>
                <th scope="col">total capacite</th>
            </tr>
        </thead>
        <tbody>
        <?php
            ...
            echo"
            <tr>
                <th scope='row'>" . $data['total_capacite'] ." </th>
            </tr>";
