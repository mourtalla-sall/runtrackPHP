...
requête SQL, sélectionnez la capacité moyenne des salles. Affichez le résultat
de cette requête dans un tableau HTML. La première ligne de votre tableau
HTML doit contenir le nom des champs. Les suivantes doivent contenir les
...
<?php
	// DSN (Data Source Name) de PDO
		...
		$sql = "SELECT AVG(capacite) as capacite_moyenne
        FROM salles ";
...
<body>
    <table>
        <thead>
            <tr>
                <th scope="col">Capacite Moyenne</th>
            </tr>
        </thead>
        <tbody>
        <?php
            ...
            echo"
            <tr>
                <th scope='row'>" . $data['capacite_moyenne'] ." </th>
            </tr>";
